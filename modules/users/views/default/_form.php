...
<div class="users-form">
    ...
    <div class="row">
        <div class="col-md-4">
            <?= $form->field($model, 'status')->dropDownList(\app\modules\users\models\User::getStatusList(), ['maxlength' => true]) ?>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'role')->dropDownList(\yii\helpers\ArrayHelper::map(\Yii::$app->authManager->getRoles(), 'name', 'description'), ['maxlength' => true]) ?>
        </div>
    </div>
